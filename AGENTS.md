# D2U Partner - Agent Notes

Rules only. Short. Actionable.

## Core Rules

- Namespaces: `D2U_Partner` for data classes, `TobiasKrais\D2UPartner` for module classes
...
- For changes under `modules/25/*`: check or update changelog in `pages/help.changelog.php`
